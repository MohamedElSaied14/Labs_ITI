...
class Database {
    ...
    private function __construct() {
        try {
            ...
            // Upgrade: add profile_image column if it doesn't exist yet
            try {
                $this->pdo->exec("ALTER TABLE users ADD COLUMN profile_image VARCHAR(255) NOT NULL DEFAULT ''");
...
/**
 * Convenience wrapper – keeps all existing code (getDB()->prepare(...)) working
 * without any changes to the other files.
 */
function getDB(): PDO {
